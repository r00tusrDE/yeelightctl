...
```
2. You can set names for your bulbs so you don't need to always type out the ip of the bulb that you want to control. To set names open the bulbs.csv file (contained in this repo) and use one line per bulb. Use the following syntax in the CSV file:
```csv
<bulb_name>,<bulb_ip>
```
